		...
		<view class="main">
			<view class="content">
				<view class="nav">
					...
					<view class="nav-list" id="life0">充值记录</view>
						...
						<view class="lists">
							<view class="huiyuan_hanzi">
								<view class="name" style="white-space: nowrap;">
									<lable><image class="sexImg" :src="huiyuanVal.image" style="height: 24upx; width: 24upx;"></image></lable>&nbsp;&nbsp;&nbsp;
									<label for="" style="white-space: nowrap;">{{ huiyuanVal.name }}</label>
								...
								<view class="phone1">
									开卡金额:<label style="color:#F87D24; margin-right: 230upx;">￥500</label>
									<label style=" white-space: nowrap;">操作人员: 张三</label>
								</view>
							</view>
						</view>
					</view>
	...
	export default {
		...
		data() {
			...
			return {
				...
				chuxuka:'../../static/start_card_record/chuxuka.png',//
				cishuka:'../../static/start_card_record/cishuka.png',//
				shixiaoka:'../../static/start_card_record/shixiaoka.png',//
				zhekouka:'../../static/start_card_record/zhekouka.png',//
		...
		onLoad(option) {
			...
			let arrmem = [
				{image:'../../static/start_card_record/chuxuka.png',name:'储值卡',posi:'青年',posstate:'在职',number:'九折卡',sex:'男',idcardval:'11111',datepos:'2018-05-05',memberIntro:'我是张三'},
				{image:'../../static/start_card_record/chuxuka.png',name:'次数卡',posi:'少年',posstate:'在职',number:'一年内无限次理发',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/shixiaoka.png',name:'折扣卡',posi:'中年',posstate:'在职',number:'一年内无限次理发',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/cishuka.png',name:'储值卡',posi:'老年',posstate:'在职',number:'充500送300',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/shixiaoka.png',name:'时效卡 ',posi:'青年',posstate:'在职',number:'充500送300',sex:'男',idcardval:'11111',datepos:'2018-05-05',memberIntro:'我是张三'},
				{image:'../../static/start_card_record/cishuka.png',name:'次数卡',posi:'少年',posstate:'在职',number:'一年内无限次理发',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/zhekouka.png',name:'时效卡 ',posi:'中年',posstate:'在职',number:'充500送300',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/zhekouka.png',name:'折扣卡',posi:'老年',posstate:'在职',number:'九折卡',sex:'女',idcardval:'22222',datepos:'2018-05-05',memberIntro:'我是王红'},
				{image:'../../static/start_card_record/zhekouka.png',name:'储值卡',posi:'青年',posstate:'在职',number:'一年内无限次理发',sex:'男',idcardval:'11111',datepos:'2018-05-05',memberIntro:'我是张三'}
			]
			...
			for(let i=0; i < arrmem.length;i++){
				...
				// if(posi == "储值卡"){
					_this.huiyuan.push({image,name,posi,number,sex,posstate,idcardval,datepos,memberIntro});
				// }else if(posi == "次数卡"){
